...
public class Main {
    public static void main(String[] args) {
        ...
        Worker w1 = new Worker(); // Создаем экзкмпляр Worker
        w1.firstName = "Имя_1";
        ...
        System.out.println(w1.equals(w4)); // переписали метод в Родительском классе
        ...
        var workers = new HashSet<Worker>(Arrays.asList());
        workers.add(w1);
        workers.add(w2);
        workers.add(w3);
